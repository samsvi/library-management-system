...
public class BookRestController {
    ...
    @Operation(summary = "Get all books", description = "Retrieve a paginated list of all books in the library")
    @ApiResponse(responseCode = "200", description = "Successfully retrieved list of books")
    @GetMapping
    public ResponseEntity<Page<BookResponseDto>> getAllBooks(@ParameterObject @PageableDefault(size = 10, sort = "title", direction = Sort.Direction.ASC) Pageable pageable) {
